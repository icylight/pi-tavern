...
- 状态：**已完成（Phase 1–5 收口归档，2026-08-03 #88）**——Phase 1–4 已合入 main @ b71af53，ADR-0005 已转 Accepted（2026-08-02）；本文档归档为完成态计划，后续结构演进以 docs/architecture/adr/0005-io-pipeline-five-layer.md（实施后差异核注段）+ docs/architecture/architecture.md 为准。
